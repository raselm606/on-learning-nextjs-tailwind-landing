    ...
    <>
        ...
        <div className="w-full bg-[#D2E6E4] ">
            <div className="flex  px-4 gap-5 flex-col md:flex-row max-w-7xl mx-auto py-25">
             ...
             <p className="text-[#0B7077]  px-4 mx-auto mt-2 text-[12px] font-semibold text-center pb-8">© 2026 Copyright  ( Figma Community template ) & <Link className="font-bold" href="https://raselm.com">Raselm.com</Link> converted into <strong>NextJS</strong> with <strong>Tailwinds</strong></p>
        </div>
